...
UNREALROOTPATH = /home/leonardo/Git/UnrealEngine
GAMEPROJECTFILE =/home/leonardo/Dokumente/Unreal Projects/Building_Escape/Building_Escape.uproject
...
Building_Escape-Linux-Debug:
	 $(PROJECTBUILD) Building_Escape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_Escape-Linux-DebugGame:
	 $(PROJECTBUILD) Building_Escape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_Escape-Linux-Shipping:
	 $(PROJECTBUILD) Building_Escape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_Escape-Linux-Test:
	 $(PROJECTBUILD) Building_Escape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_Escape:
	 $(PROJECTBUILD) Building_Escape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_EscapeEditor-Linux-Debug:
	 $(PROJECTBUILD) Building_EscapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_EscapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) Building_EscapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_EscapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) Building_EscapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_EscapeEditor-Linux-Test:
	 $(PROJECTBUILD) Building_EscapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Building_EscapeEditor:
	 $(PROJECTBUILD) Building_EscapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
